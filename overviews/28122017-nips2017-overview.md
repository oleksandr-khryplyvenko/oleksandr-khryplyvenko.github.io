---
layout: page
title: NIPS 2017 overview
permalink: /overviews/28122017-nips2017-overview.html
---

### The following overview covers only presentations I visited<br>It reflects my personal opinion
### To me, this was the best @ NIPS 2017

### [click here to view all NIPS 2017 videos](https://www.facebook.com/nipsfoundation/videos)

Some videos contain ~ 10 posters/presentations, or even more.<br>
So virtually everything presented @ NIPS is available there.<br>
...
<tr>
    <td colspan="4" align="center">
        <a href="http://interpretable.ml/">Interpretable ML</a><br>
...
### random interesting things(not all are available online yet)


[Efficient Multi-task Feature and Relationship Learning](https://arxiv.org/pdf/1702.04423.pdf)<br>
learning to search via self-limitation<br>
[A DIRT-T APPROACH TO UNSUPERVISED DOMAIN ADAPTATION](https://openreview.net/pdf?id=H1q-TM-AW)<br>
the mutation sampler: a sampling approach to casual representation<br>
[Variational Probability Flow for Biologically Plausible Training of Deep Neural Networks](https://arxiv.org/pdf/1711.07732.pdf)<br>
scale-invariant temporal memory in ai<br>
[Scale-invariant temporal history (SITH): optimal slicing of the past in an uncertain world](https://arxiv.org/pdf/1712.07165.pdf)<br>
efficient human-like semantic representations via the information bottleneck principle<br>
representational primitives in minds and machines (Gary Marcus)<br>


### main directions & trends
