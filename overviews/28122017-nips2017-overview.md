...
[Efficient Multi-task Feature and Relationship Learning](https://arxiv.org/pdf/1702.04423.pdf)
learning to search via self-limitation
[A DIRT-T APPROACH TO UNSUPERVISED DOMAIN ADAPTATION](https://openreview.net/pdf?id=H1q-TM-AW)
the mutation sampler: a sampling approach to casual representation
[Variational Probability Flow for Biologically Plausible Training of Deep Neural Networks](https://arxiv.org/pdf/1711.07732.pdf)
scale-invariant temporal memory in ai
[Scale-invariant temporal history (SITH): optimal slicing of the past in an uncertain world](https://arxiv.org/pdf/1712.07165.pdf)
efficient human-like semantic representations via the information bottleneck principle
representational primitives in minds and machines (Gary Marcus)
